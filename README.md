...
The first variable we looked at was the number of possessions per player. we did this by creating a scatter plot and a regression line, which showcased a weak, but positive correlation.  
